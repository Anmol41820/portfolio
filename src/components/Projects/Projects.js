        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="Received extensive group mentoring from Microsoft, which helps me in enhancing my efficiency to do effective work. Application takes all the student data including photo and store in the database of MySQL. Attendance is marked automatically. It also constains few games to enjoy - Making the sketch automatically and Facial emotion using your face via camera instantaneous."
